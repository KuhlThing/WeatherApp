...
$(button).on("click", function () {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?zip=" + zip + "&units=imperial&APPID=77cadc7a61c1ae3fea4ab591eeccc637";
...
function uvCall() {
    ...
    var uvApi = "https://api.openweathermap.org/data/2.5/uvi?appid=77cadc7a61c1ae3fea4ab591eeccc637&lat=" + latitude + "&lon=" + longitude;
...
function fiveDay() {
    ...
    var zip = cityZip[0];
    var fdApi = "https://api.openweathermap.org/data/2.5/forecast?zip=" + zip + "&units=imperial&APPID=77cadc7a61c1ae3fea4ab591eeccc637";
...
if (localStorage.getItem("zip-history")) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?zip=" + zipHistory + "&units=imperial&APPID=77cadc7a61c1ae3fea4ab591eeccc637";
